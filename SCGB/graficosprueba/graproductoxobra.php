            ...
            <div class="row-fluid hidden-print">
               <div class="span12">
                  ...
                  <ul class="breadcrumb hidden-print">
                     ...
                     <li>
                        <a href="menu_graficos.php">Graficos</a>
                        <i class="icon-angle-right"></i>
                     </li>
               ...
               <div class="span12">
                  ...
                  <div class="widget box green">
                     <div class="widget-title hidden-print">
                        <h4><i class="icon-reorder hidden-print"></i>Cantidad de Ropa en bodega </h4>
                        <div class="tools">
...
$res = $cn->Consulta("SELECT DISTINCT O.O_NOMBRE ,p.P_NOMBRE, count(dp.CODIGOPRODUCTO) as CANTIDAD FROM producto p,detalle_prestamo dp,obra o WHERE dp.CODIGOPRODUCTO=p.CODIGOPRODUCTO and dp.CODIGOPRESTAMO in (select pr.CODIGOPRESTAMO from prestamo pr where pr.CODIGOOBRA=(SELECT distinct(p.CODIGOOBRA)FROM obra  as o INNER JOIN prestamo p
ON  o.CODIGOOBRA=p.CODIGOOBRA and o.O_ESTADO=1)) GROUP BY p.P_NOMBRE
");

while ($row = $cn->getRespuesta($res)){
   $array['P_NOMBRE'] = $row['O_NOMBRE'];
   $array['P_IDENTIFICADOR'] = $row['P_NOMBRE'];
...
tooltip: {
	...
	palette: "Soft Pastel ocean",
    title: "Insumos en bodega",
