...
<!-- END SIDEBAR -->
   ...
   <script src="../assets/scripts/form-validation.js"></script> 
	...
	$sqlrut = "SELECT distinct(p.RUT),p.PD_NOMBRE,p.PD_DIRECCION,p.PD_TELEFONO FROM proveedor p INNER JOIN ingreso_producto i
ON  p.RUT=i.RUT and p.PD_ESTADO=1";
	conectar();
	$ruut=mysql_query($sqlrut,$conexion);	
	while ($rowrut=mysql_fetch_array($ruut)){
