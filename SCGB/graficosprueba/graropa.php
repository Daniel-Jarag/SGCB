...
$res = $cn->Consulta("SELECT  p.CODIGOPRODUCTO,p.P_NOMBRE,s.S_CANTIDAD as CANTIDAD FROM ropa i,producto p,stock s
...
while ($row = $cn->getRespuesta($res)){
	...
	$array['P_IDENTIFICADOR'] = $row['CODIGOPRODUCTO'];
	$array['P_NOMBRE'] = $row['P_NOMBRE'];
