            ...
            <div class="row-fluid">
               <div class="span12">
                  ...
                  <ul class="breadcrumb">
                     ...
                     <li><a href="mod_proveedor.php">Buscar Proveedor</a></li>
                  </ul>
               ...
               <div class="span12">
                  <div class="widget box green">
                     <div class="widget-title">
                        <div class="widget-title">
                        <h4><i class="icon-globe"></i>Tabla Proveedor </h4>
                     </div>
                     </div>
                     <div class="widget-body form">
                     <div class="clearfix margin-bottom-10">
                           <div class="btn-group">
                              <button id="sample_editable_1_new" class="btn btn-success" onclick = "location.href = 'add_proveedor.php'">
                              Agregar Proveedor <i class="icon-plus"></i>
                              </button>
                           </div>
                       </div>
                        ...
                        <form action="" method="post" id="form2" name="form2"  class="form-horizontal">
                          <input type="hidden" name="CODIGO" id="CODIGO" />
                           <div class="control-group">
                              ...
                              <div class="controls">
                                 <input  name="RUT" type="text" class="span6 " id="RUT"  disabled="disabled"/>
                              </div>
                           </div>
                           <div class="control-group">
                          ...
                          <div class="control-group">
                           ...
                           <div class="control-group">
                              ...
                              <div class="controls">
                                  <input type="number" name="TELEFONO" id="TELEFONO"  class="span6"  required min="0"/>
                              </div>
                           </div>
                           <div class="control-group">
  ...
  App.init();
   ...
   $("#btnFancybox").fancybox();
		   ...
		   EMAIL= $('#EMAIL').val()        
            ...
            $.fancybox.close();
			$.msgbox("Proveedor Modificado Exitosamente",{type: "info",buttons : [{type: "submit", value: "Aceptar"}]},function(result) { if(result=="Aceptar"){window.location.href='mod_proveedor.php';} });
        });
   })
   ...
   function editarProveedor(id) {
    ...
    function eliminarProveedor(id,nombre) {
		 $.msgbox("¿Desea Eliminar el Proveedor "+nombre+"?", {type: "confirm",buttons : [{type: "submit", value: "SI"},{type: "submit", value: "NO"}]}, function(result) { 
		 if(result=="SI"){
			  $.getJSON("obtProveedorId.php", {id_proveedor: id}, function(data) {
				   ...
				   $.ajax({
                     ...
                     data: { CODIGO: CODIGO},
                     success: function(data){
					  $.msgbox("Proveedor Eliminado Exitosamente",{type: "info",buttons : [{type: "submit", value: "Aceptar"}]},function(result) { if(result=="Aceptar"){window.location.href='mod_proveedor.php';} });
                     }
                  });
               })
			 } 
