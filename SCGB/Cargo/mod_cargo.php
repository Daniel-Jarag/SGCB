               ...
               <div class="span12">
                  <div class="widget box green">
                     ...
                     <div class="clearfix margin-bottom-10">
                           <div class="btn-group">
                              <button id="sample_editable_1_new" class="btn btn-success" onclick = "location.href = 'add_cargo.php'">
                              Agregar Cargo <i class="icon-plus"></i>
                              </button>
                           </div>
                       </div>
                 ...
                 <div style="display: none;" id='editarFormulario'>
                    ...
                    <form action="" method="post" id="formulario2" name="formulario2"  class="form-horizontal"> 
                           ...
                           <h3>Datos de cargo</h3>
                              <div class="control-group">
                                <label class="control-label">Nombre</label>
                                 <div class="controls">
                                 <input type="text" name="NOMBRE" id="NOMBRE"  class="span6" data-trigger="hover" required />
                              </div>
                           </div>
                          <div class="control-group">
                            <label class="control-label">Descripcion</label>
                             <div class="controls">
                              <textarea name="DESCRIPCION" class="span6" id="DESCRIPCION" maxlength="200" data-trigger="hover" required></textarea>
                             </div>
                           </div>
                          <div class="control-group">
...
<script type="text/javascript" src="../js_mantenedores/jquery.msgbox.min.js"></script>
 <script>
   ...
   App.init();
           ...
           DESCRIPCION= $('#DESCRIPCION').val()        
            ...
            $.ajax({
                ...
                data: { CODIGOCARGO: CODIGOCARGO,NOMBRE: NOMBRE, DESCRIPCION: DESCRIPCION},
			...
			$.fancybox.close();
			$.msgbox("Cargo Modificado Exitosamente",{type: "info",buttons : [{type: "submit", value: "Aceptar"}]},function(result) { if(result=="Aceptar"){window.location.href='mod_cargo.php';} });
        });
   })
   ...
   function editarCargo(id) {
                   $.getJSON("obtCargoId.php", {id_cargo: id}, function(data) {
                    $("#CODIGOCARGO").val(data[0].CODIGOCARGO)
   ...
   function eliminarCargo(id,nombre) {
	   ...
	   $.msgbox("¿Desea Eliminar el Cargo "+nombre+"?", {type: "confirm",buttons : [{type: "submit", value: "SI"},{type: "submit", value: "NO"}]}, function(result) { 
		 if(result=="SI"){
			 $.getJSON("obtCargoId.php", {id_cargo: id}, function(data) {
                    $("#CODIGOCARGO").val(data[0].CODIGOCARGO)
				   ...
				   $.ajax({
                     type: 'POST',
                      ...
                      data: { CODIGO: CODIGO},
                      success: function(data){
					  $.msgbox("Cargo Eliminado Exitosamente",{type: "info",buttons : [{type: "submit", value: "Aceptar"}]},function(result) { if(result=="Aceptar"){window.location.href='mod_cargo.php';} });
                     }
                  });
               })
			 } 
