         ...
         <div class="container-fluid">
            ...
            <div class="row-fluid">
               <div class="span12">
                  ...
                  <h3 class="page-title">Graficos Trabajador </h3>
                  <ul class="breadcrumb">
                     <li>
                        <i class="icon-home"></i>
               ...
               <div class="span12">
                  ...
                  <div class="widget box green">
                     <div class="widget-title">
                        <h4><i class="icon-reorder"></i>Informe trabajador  </h4>
                     </div>
                     <div class="widget-body form">
                        <!-- Iniio de Botones-->
                           <div class="row-fluid">
                              <a href="" class="icon-btn span3">
                                 <img src="../Imagenes/invest.png" width="29" height="25" >
                                 <div>Herramienta </div></img>
