         ...
         <div class="container-fluid ">
            ...
            <div class="row-fluid hidden-print">
               <div class="span12">
                  ...
                  <h3 class="page-title hidden-print">Proveedores</h3>
                  <ul class="breadcrumb hidden-print">
                     ...
                     <li><a href="../Herramienta/add_herramienta.php">Agregar Herramienta</a></li>
                  </ul>
               ...
               <div class="span12">
                  ...
                  <div class="widget box green">
                     <div class="widget-title hidden-print">
                        <h4><i class="icon-reorder hidden-print"></i>Cantidad de producto a proveedores</h4>
                        <div class="tools">
                    ...
                    <div class="widget-body form">
                        ...
                        <!-- BEGIN FORM-->
                       <h3>Producto adquiridos a proveedores </h3>
                        <p>
                          <!-- END FORM-->
                        </p>
...
$cn->Conectar();
$return_arr = array();
$res = $cn->Consulta("SELECT proveedor.PD_NOMBRE AS nombre, SUM( ingreso_producto.IP_CANTIDAD ) AS total
FROM proveedor, ingreso_producto
WHERE proveedor.rut = ingreso_producto.rut
AND proveedor.pd_estado =1
GROUP BY proveedor.PD_NOMBRE
ORDER BY total DESC ");

while ($row = $cn->getRespuesta($res)){
    $array['nombre'] = $row['nombre'];
	 $array['total'] = (int) $row['total'];
...
tooltip: {
    ...
    dataSource: data,
	palette: "Pastel",
    title: "producto adquidiros a proveedores",
    legend: {
