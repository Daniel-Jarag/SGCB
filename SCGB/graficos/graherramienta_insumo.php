...
<?
  $sql="Select count(CODIGOPRODUCTO)+1 AS ID from herramienta";
  conectar();
           ...
           <li class="has-sub ">
            ...
            <li class="has-sub start active  ">
               ...
               <ul class="sub">
				 ...
				 <li class="active"><a href="../graficos/menu_graficos.php">Graficos</a></li>
            ...
            <div class="row-fluid hidden-print">
               <div class="span12">
                  ...
                  <ul class="breadcrumb">
                     <li>
                        <i class="icon-home"></i>
                        <a href="../Herramienta/index.php">Incio</a> 
...
while ($row = $cn->getRespuesta($res)){
	...
	$array['P_IDENTIFICADOR'] = $row['P_IDENTIFICADOR'];
