...
<div id="body">
     ...
     <div class="container-fluid">
            <div class="row-fluid">
               <div class="span12">
                  <h3 class="page-title">Vehiculo</h3>
                  <ul class="breadcrumb">
                     <li>
                        <i class="icon-home"></i>
                     ...
                     <li><a href="add_vehiculo.php">Vehiculo</a></li>
                  </ul>
               ...
               <div class="span12">
                  <div class="widget box green">
                     <div class="widget-title">
                        <div class="widget-title">
                        <h4><i class="icon-globe"></i>Tabla Vehiculo </h4>
                     </div>
                     </div>
                     <div class="widget-body form">
                     <div class="clearfix margin-bottom-10">
                           <div class="btn-group">
                              <button id="sample_editable_1_new" class="btn btn-success" onclick = "location.href = 'add_vehiculo.php'">
                              Agregar Vehiculo <i class="icon-plus"></i>
                              </button>
                           </div>
                       </div>
                      ...
                      <div style="display: none;" id='editarFormulario'>
                        ...
                        <form action="" method="post" id="form2" name="form2"  class="form-horizontal">
                          ...
                          <div class="alert alert-error hide">
                           ...
                           <input type="hidden" name="CONDICIONANTIGUA"  id="CODIGOCONDICIONANTIGUA" />
                           <div class="control-group">
                              <label class="control-label">Patente <span class="required">*</span></label>
                              <div class="controls">
                                 <input  name="CODIGO" type="text" class="span6  m-wrap tooltips" id="CODIGO" readonly data-trigger="hover" data-original-title="Ingrese un codigo de herramienta." required />
                              </div>
                           </div>
                           
                          <div class="control-group">
                           <label class="control-label">Tipo de Vehiculo<span class="required">*</span></label>
                           <div class="controls"> <select class="span2 " name="NOMBRE"id ="NOMBRE">
                           ...
                           <div class="control-group">
                              ...
                              <div class="controls">
                                 <input type="text"  name="MARCA" id="MARCA" class="span6  m-wrap tooltips" data-trigger="hover" data-original-title="" required  />
                              </div>
                           </div>
                           ...
                           <div class="control-group">
                              ...
                              <div class="controls">
                                 <input type="text"  name="MODELO" id="MODELO" class="span6  m-wrap tooltips" data-trigger="hover" data-original-title="" required />
                              </div>
                          </div>
                           
                           <div class="control-group">
                           <label class="control-label">Condición del Vehiculo<span class="required">*</span></label>
                           <div class="controls"> <select class="span2 " name="CONDICION"id ="CONDICION" onclick="tipo();">
                           ...
                           <div class="control-group">
                              <label class="control-label">Patente <span class="required">*</span></label>
                              <div class="controls">
                                 <input  name="PATENTE" type="text" class="span6  m-wrap tooltips" id="PATENTE" data-trigger="hover" data-original-title="" required />
                              </div>
                          </div>
                            
                          <div class="control-group">
                              <label class="control-label">Permiso de Circulacion Vigente<span class="required">*</span></label>
                              <div class="controls">
                                 <input type="text"  name="PERMISO" id="PERMISO" class="span6  m-wrap tooltips" data-trigger="hover" data-original-title="" required  />
                              </div>
                          </div>
                           ...
                           <div class="control-group">
                              ...
                              <div class="controls">
                                 <input type="number" min="2000" max="2100"  name="YEAR" id="YEAR" class="span6  m-wrap tooltips" data-trigger="hover" data-original-title=""  />
                              </div>
                          </div>
 ...
 <script>
   ...
   $("#btnFancybox").fancybox();
		   ...
		   OBSERVACION= $('#OBSERVACION').val()      
			...
			actualizarVehiculo();
			if($('#CONDICION').val()!=$('#CONDICIONANTIGUA').val()){
				  if($('#CONDICION').val()=="Particular"){
				...
				window.setTimeout('(window.location.href=mod_vehiculo.php)',99);
			$.fancybox.close();
			alertify.alert("Vehiculo agregado exitosamente");
        });
   })
   ...
   function actualizarVehiculo(){
		   ...
		   $.ajax({
                ...
                data: { CODIGO:CODIGO, PERMISO:PERMISO, PATENTE:PATENTE, YEAR:YEAR,CONDICION:CONDICION}
		         });
		  }
   function actualizarStock(){
		   ...
		   $.ajax({
                type: 'POST',
                url: '../Stock/actualizar_stockVehiculo.php',
   ...
   function guardarDetalleProducto(){
    ...
    function eliminarDetalleProducto(){
		   ...
		   $.ajax({
                type: 'POST',
                url: '../Producto_Unitario/eliminar_productoUnitarioId.php',
                data: { CODIGO:CODIGO, CODIGOUNITARIO:CODIGOUNITARIO, NUMEROFACTURA:NUMEROFACTURA}
		         });
		  }
	function guardarStock2(){
		   CODIGO= $('#CODIGO').val()
   ...
   function editarVehiculo(id) {
	  ...
	  function tipo(){
	   var seleccionado=$('#CONDICION').val();
	   if(seleccionado=="Particular"){
		     document.getElementById('PATENTE').disabled = false;document.getElementById('PATENTE').value="";
			 document.getElementById('CANTIDADMINIMA').disabled = true;document.getElementById('CANTIDADMINIMA').value="0";
		  }
		else{ 
		     document.getElementById('PATENTE').disabled = true;document.getElementById('PATENTE').value="";
			 document.getElementById('CANTIDADMINIMA').disabled = false;document.getElementById('CANTIDADMINIMA').value="0";
		}   
	}
	function eliminarUsuario(id) {
		alertify.confirm("Desea Eliminar este Vehiculo", function (e) {
					if (e==false) {
						     return;  
					       }
					 else {
                      $.getJSON("obtUsuarioId.php", {id_usuario: id}, function(data) {
				      CODIGO= data[0].LOGIN
				   $.ajax({
                     type: 'POST',
                    ...
                    data: { CODIGO: CODIGO},
                      success: function(data){
				      window.location.href='mod_usuario.php';
                       }
                         });
                         }) 
						} 
