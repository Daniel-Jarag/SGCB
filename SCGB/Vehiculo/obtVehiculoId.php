...
$cn->Conectar();
$return_arr = array();
$res = $cn->Consulta("SELECT p.CODIGOPRODUCTO,p.P_NOMBRE,p.P_MARCA,p.P_MODELO,p.P_OBSERVACION,v.V_PERMISO,v.V_YEAR,v.V_CONDICION,v.V_PATENTE,s.S_CANTIDADMINIMA FROM vehiculo v,prodcto p,stock s WHERE p.CODIGOPRODUCTO=v.CODIGOPRODUCTO AND p.CODIGOPRODUCTO=s.CODIGOPRODUCTO AND p.CODIGOPRODUCTO='$id_vehiculo'");
