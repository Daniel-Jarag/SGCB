            ...
            <div class="row-fluid">
               <div class="span12">
                  ...
                  <ul class="breadcrumb">
                     ...
                     <li>
                        <a href="mod_vehiculo.php">Vehiculo</a>
                        <i class="icon-angle-right"></i>
                     </li>
                     <li><a href="add_vehiculo.php">Agregar Vehiculo</a></li>
                  </ul>
               ...
               <div class="span12">
                  <div class="widget box green">
                     <div class="widget-title">
                        <h4><i class="icon-reorder"></i>Agredar Vehiculo</h4>
                     </div>
                        ...
                        <form action="" method="post" id="form2" name="form2"  class="form-horizontal">
                          ...
                          <div class="alert alert-error hide">
                           ...
                           <div class="control-group">
                              <label class="control-label">Codigo Vehiculo <span class="required">*</span></label>
                              <div class="controls">
							  <?php $sql="Select count(CODIGOPRODUCTO)+1 AS ID from vehiculo";

conectar();
$rs=mysql_query($sql,$conexion);
							  while ($row=mysql_fetch_array($rs)){?>
                             <input  name="CODIGO" type="text" class="span6  m-wrap tooltips" id="CODIGO"  value="VEH-<?=$row["ID"]; }?> " readonly />
                             </div>
                           </div>
                           ...
                           <div class="control-group">
                              ...
                              <div class="controls">
                                 <input type="text"  name="MARCA" id="MARCA" class="span6  m-wrap tooltips" placeholder="Ingrese marca vehiculo" required />
                              </div>
                           </div>
                           ...
                           <div class="control-group">
                              ...
                              <div class="controls">
                                 <input type="text"  name="MODELO" id="MODELO" class="span6  m-wrap tooltips" placeholder="Ingrese modelo vehiculo" required />
                              </div>
                          </div>
                           ...
                           <div class="control-group">
                              ...
                              <div class="controls">
                                 <input  name="PATENTE" type="text" disabled="disabled" class="span6  m-wrap tooltips" id="PATENTE" data-trigger="hover" placeholder="" />
                              </div>
                          </div>
                          ...
                          <div class="control-group">
                              ...
                              <div class="controls">
                                 <input type="date"  name="PERMISO" id="PERMISO" class="span6  m-wrap tooltips" placeholder="Ingrese permiso de circulacion"  />
                              </div>
                          </div>
                           ...
                           <div class="control-group">
                              ...
                              <div class="controls">
                                 <input type="number"  name="YEAR" id="YEAR" class="span6  m-wrap tooltips" placeholder="Selecione año" min="2000" max="2100"  />
                              </div>
                          </div>
...
<script type="text/javascript" src="../js_mantenedores/alertify.js"></script>
   ...
   <script>
	   ...
	   $("#form2").submit(function(e){ 
		   ...
		   IDENTIFICADOR= "V"            
            ...
            $.ajax({
			   ...
			   form2.CODIGO.value = "";
			   form2.NOMBRE.value = "Auto";
               form2.MARCA.value = "";
               form2.MODELO.value = "";
			   form2.CONDICION.value = "Arriendo";
			   form2.PERMISO.value = "";
			   form2.PATENTE.value = "";
			   form2.YEAR.value = "";
	  ...
	  function guardaVehiculo(){
	    ...
	    function volver(){
	      window.location.href='mod_vehiculo.php';
		 }
