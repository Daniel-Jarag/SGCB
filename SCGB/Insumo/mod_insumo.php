            ...
            <div class="row-fluid">
               <div class="span12">
                  ...
                  <ul class="breadcrumb">
                     ...
                     <li>
                        <a href="../Producto/Productos.php">Producto</a>
                        <i class="icon-angle-right"></i>
                     </li>
                     <li><a href="add_insumo.php">Insumo</a></li>
                  </ul>
               ...
               <div class="span12">
                  <div class="widget box green">
                     <div class="widget-title">
                        <div class="widget-title">
                        <h4><i class="icon-globe"></i>Tabla insumo</h4>
                     </div>
                     </div>
                     <div class="widget-body form">
                     <div class="clearfix margin-bottom-10">
                           <div class="btn-group">
                              <button id="sample_editable_1_new" class="btn btn-success" onclick = "location.href = 'add_insumo.php'">
                              Agregar Insumo <i class="icon-plus"></i>
                              </button>
                           </div>
                       </div>
                        ...
                        <form action="" method="post" id="form2" name="form2"  class="form-horizontal">
                          ...
                          <div class="alert alert-error hide">
                           ...
                           <div class="control-group">
                              ...
                              <div class="controls">
                                 <input type="text"  name="MEDIDA" id="MEDIDA" class="span6  m-wrap tooltips" data-trigger="hover" data-original-title="Ingrese una talla de insumo." required />
                              </div>
                           </div>
                           <div class="control-group">
                    ...
                    <label class="control-label">Tipo de unidad<span class="required">*</span></label>
                     <div class="controls"> <select class="span2 " name="UNIDAD"id ="UNIDAD" onclick="tipo();">
                           ...
                           <div class="control-group">
                              ...
                              <div class="controls">
                                <input  name="CANTIDAD" type="text" disabled="disabled" class="span2  m-wrap tooltips" id="CANTIDAD" maxlength="3"  value="1" data-trigger="hover" data-original-title="" required />
                              </div>
                           </div>
 ...
 <script>
   ...
   $("#btnFancybox").fancybox();
		   ...
		   OBSERVACION= $('#OBSERVACION').val()      
			...
			actualizarInsumo();
			actualizarStock();
			window.setTimeout('(window.location.href=mod_insumo.php)',99);
			$.fancybox.close();
			alertify.alert("Insumo modificado exitosamente");
        });
   })
