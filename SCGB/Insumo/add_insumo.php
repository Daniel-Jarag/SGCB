            ...
            <div class="row-fluid">
               <div class="span12">
                  ...
                  <ul class="breadcrumb">
                     ...
                     <li>
                        <a href="mod_insumo.php">Insumo</a>
                        <i class="icon-angle-right"></i>
                     </li>
                     <li><a href="add_insumo.php">Agregar Insumo</a></li>
                  </ul>
               ...
               <div class="span12">
                  <div class="widget box green">
                     <div class="widget-title">
                        <h4><i class="icon-reorder"></i>Agredar Insumo</h4>
                    </div>
                        ...
                        <form action="" method="post" id="form2" name="form2"  class="form-horizontal">  
                          <div class="alert alert-error hide">
                           ...
                           <div class="control-group">
                              ...
                              <div class="controls">
							  <? 
							  $sql="Select count(CODIGOPRODUCTO)+1 AS ID from insumo";
conectar();
$rs=mysql_query($sql,$conexion);
while ($row=mysql_fetch_array($rs)){?>
                             <input type="text"  name="CODIGO" id="CODIGO" class="span6  m-wrap tooltips" data-trigger="hover" data-original-title="Ingrese un codigo de insumo."  value="INS-<?=$row["ID"]; }?> " disabled="disabled"/>
                             </div>
                           </div>
                           ...
                           <div class="control-group">
                              ...
                              <div class="controls">
                                <input type="text"  name="NOMBRE" id="NOMBRE" class="span6  m-wrap tooltips"  placeholder="Ingrese nombre de insumo." required />
                             </div>
                           </div>
                           ...
                           <div class="control-group">
                              ...
                              <div class="controls">
                                 <input type="text"  name="MARCA" id="MARCA" class="span6  m-wrap tooltips" placeholder="Ingrese marca de insumo" required />
                              </div>
                           </div>
                           ...
                           <div class="control-group">
                              ...
                              <div class="controls">
                                 <input type="text"  name="MODELO" id="MODELO" class="span6  m-wrap tooltips" placeholder="Ingrese modelo de insumo." required />
                              </div>
                           </div>
                           ...
                           <div class="control-group">
                              ...
                              <div class="controls">
                                 <input type="text"  name="MEDIDA" id="MEDIDA" class="span6  m-wrap tooltips" placeholder="Ingrese medida o talla de insumo." required />
                              </div>
                           </div>
                           <div class="control-group">
                    <label class="control-label">Tipo de Medida<span class="required">*</span></label>
                     <div class="controls"> <select class="span2 " name="TIPOMEDIDA"id ="TIPOMEDIDA">
                           ...
                           <div class="control-group">
                    <label class="control-label">Tipo de Unidad<span class="required">*</span></label>
                     <div class="controls"> <select class="span2 " name="UNIDAD"id ="UNIDAD" onclick="tipo();">
                           ...
                           <div class="control-group">
                              ...
                              <div class="controls">
                                 <input  name="CANTIDAD" type="number" disabled="disabled" class="span2  m-wrap tooltips" id="CANTIDAD" maxlength="3"  value="1" data-trigger="hover" data-original-title="" required min="0" max="1000" />
                              </div>
                           </div>
	   ...
	   $("#form2").submit(function(e){ 
		   ...
		   IDENTIFICADOR= "I"   
            ...
            $.ajax({
			   ...
			   form2.MODELO.value = "";
			   form2.MEDIDA.value = "";
			   form2.TIPOMEDIDA.value = "Pulgada";
			   form2.UNIDAD.value = "Unitario";
			   form2.CANTIDAD.disabled = true;
			   form2.CANTIDAD.value = "1";
			   form2.OBSERVACION.value = "";
			   form2.CANTIDADMINIMA.value = "0";
     alertify.alert("Insumo agregado exitosamente");
                }
            });
	  ...
	  function guardaInsumo(){
		   ...
		   $.ajax({
                ...
                data: { CODIGO:CODIGO, MEDIDA:MEDIDA, TIPOMEDIDA:TIPOMEDIDA, UNIDAD:UNIDAD, CANTIDAD:CANTIDAD},
				success: function(data){
				       form2.CODIGO.value = "INS-"+data;
					 }
		  ...
		  function volver(){
		     window.location.href='mod_insumo.php';
		  }
		  
   function tipo(){
	  var seleccionado=$('#UNIDAD').val();
	   if(seleccionado=="Caja"){
		     document.getElementById('CANTIDAD').disabled = false;document.getElementById('CANTIDAD').value="";
		  }
		else{ document.getElementById('CANTIDAD').disabled = true;document.getElementById('CANTIDAD').value="1";}   
	}
