...
<head>
   ...
   <link rel="stylesheet" href="../css_mantenedoressd/style_progreso.css" />
            ...
            <div class="row-fluid">
               <div class="span12">
                  ...
                  <ul class="breadcrumb">
                     ...
                     <li><a href="baja_stock.php">Producto Bajo Stock</a></li>
                  </ul>
...
<div id="footer">
   ...
   <script src="../js_mantenedores/animateprogress.js"></script>s
   
<script>
   $(document).ready(function() {
	    App.init();
		$("#tab1").load("tabla_bajoStock.php"); 
     }) 		
</script>    
