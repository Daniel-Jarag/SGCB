     ...
     <div class="container-fluid">
	      ...
	      Datos correctos!
                           ...
                           <div class="control-group">
                              <label class="control-label">Nombre de la obra <span class="required">*</span></label>
                              <div class="controls">
                                 <input type="text"  name="NOMBRE" id="NOMBRE" class="span6  m-wrap tooltips" placeholder="Ingrese nombre de la obra." required  />
                              </div>
                           </div>
                           <div class="control-group">
	 ...
	 jQuery(document).ready(function() { 
	   ...
	   $("#form2").submit(function(e){ 
           ...
           FECHAINICIO= $('#FECHAINICIO').val()        
            ...
            $.ajax({
                type: 'POST',
                url: 'guardar_obra.php',
                data: { NOMBRE: NOMBRE, FECHAINICIO: FECHAINICIO},
               success: function(data){
               form2.NOMBRE.value = "";
               form2.FECHAINICIO.value = "";
                }
            });
