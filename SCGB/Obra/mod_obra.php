               ...
               <div class="span12">
                  <div class="widget box green">
                     <div class="widget-title">
                        <div class="widget-title">
                        <h4><i class="icon-globe"></i>Tabla Obra</h4>
                     </div>
                     </div>
                     <div class="widget-body form">
                     <div class="clearfix margin-bottom-10">
                           <div class="btn-group">
                              <button id="sample_editable_1_new" class="btn btn-success" onclick = "location.href = 'add_obra.php'">
                              Agregar Obra <i class="icon-plus"></i>
                              </button>
                           </div>
                       </div>
                 ...
                 <div style="display: none;" id='editarFormulario'>
                        ...
                        <input type="hidden" name="CODIGOOBRA" id="CODIGOOBRA" />  	
                           <div class="control-group">
                              ...
                              <div class="controls">
                                 <input type="text"  name="NOMBRE" id="NOMBRE" class="span6  m-wrap tooltips" data-trigger="hover" data-original-title="Ingrese nombre de la obra."  required />
                              </div>
                           </div>
                           <div class="control-group">
                           <label class="control-label">Fecha de inicio</label>
                              <div class="controls">
                                <input  type="date" class="span6  m-wrap tooltips" name="FECHAINICIO" id="FECHAINICIO" required />
                              </div>
                              </div>
                          <div class="control-group">
 ...
 <script>
   ...
   $("#btnFancybox").fancybox();
           ...
           FECHAINICIO= $('#FECHAINICIO').val()        
            ...
            $.ajax({
            type: 'POST',
            url: 'actualizar_obra.php',
            data: { CODIGOOBRA: CODIGOOBRA,NOMBRE: NOMBRE, FECHAINICIO: FECHAINICIO},
            success: function(data){
            $.fancybox(data)
                 }
            });
			window.location.href='mod_obra.php';
            $.fancybox.close();
        });
   })
   ...
   function editarObra(id) {
                   $.getJSON("obtObraId.php", {id_obra: id}, function(data) {
                    $("#CODIGOOBRA").val(data[0].CODIGOOBRA)
