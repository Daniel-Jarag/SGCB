            ...
            <div class="row-fluid">
               <div class="span12">
                  ...
                  <ul class="breadcrumb">
                     ...
                     <li><a href="add_herramienta.php">Herramienta</a></li>
                  </ul>
               ...
               <div class="span12">
                  <div class="widget box green">
                     <div class="widget-title">
                        <div class="widget-title">
                        <h4><i class="icon-globe"></i>Tabla Herramienta</h4>
                     </div>
                     </div>
                     <div class="widget-body form">
                     <div class="clearfix margin-bottom-10">
                           <div class="btn-group">
                              <button id="sample_editable_1_new" class="btn btn-success" onclick = "location.href = 'add_herramienta.php'">
                              Agregar Herramienta <i class="icon-plus"></i>
                              </button>
                           </div>
                       </div>
                 ...
                 <div style="display: none;" id='editarFormulario'>
                        ...
                        <form action="" method="post" id="form2" name="form2"  class="form-horizontal">
                          ...
                          <div class="alert alert-error hide">
                           ...
                           <div class="control-group">
                              <label class="control-label">Codigo Herramienta <span class="required">*</span></label>
                              <div class="controls">
                           ...
                           <div class="control-group">
                              ...
                              <div class="controls">
                                <input type="text"  name="NOMBRE" id="NOMBRE" class="span6  m-wrap tooltips" data-trigger="hover" data-original-title="Ingrese nombre de herramienta."  />
                              </div>
                           </div>
                           ...
                           <div class="control-group">
                              ...
                              <div class="controls">
                                 <input type="text"  name="MARCA" id="MARCA" class="span6  m-wrap tooltips" data-trigger="hover" data-original-title="Ingrese marca de herramienta."  />
                              </div>
                           </div>
                           ...
                           <div class="control-group">
                              ...
                              <div class="controls">
                                 <input type="text"  name="MODELO" id="MODELO" class="span6  m-wrap tooltips" data-trigger="hover" data-original-title="Ingrese modelo de herramienta."  />
                              </div>
                           </div>
                           
                    <div class="control-group">
                    <label class="control-label">Tipo de Herramienta<span class="required">*</span></label>
                    ...
                    <div class="control-group">
                    <label class="control-label">Frecuencia calibración<span class="required">*</span></label>
                     ...
                     <div class="control-group">
                     <label class="control-label">Maxima Potencia<span class="required">*</span></label>
                      <div class="controls">
                        <input  name="POTENCIA" type="text" disabled="disabled" class="span6  m-wrap tooltips" id="POTENCIA" data-trigger="hover" data-original-title="" value="S/N" required />
                      </div>
                     </div>
                    ...
                    <label class="control-label">Observación <span class="required"></span></label>
                     <div class="controls">
                      <textarea name="OBSERVACION" id="OBSERVACION" maxlength="200" onKeyUp="return ismaxlength(this)" class="span6  m-wrap tooltips" data-trigger="hover" data-original-title=""></textarea>
                     </div>
                    </div>
...
<script>
   ...
   $("#btnFancybox").fancybox();
		   ...
		   OBSERVACION= $('#OBSERVACION').val()        
			...
			actualizarStock();
			window.setTimeout('(window.location.href=mod_herramienta.php)',99);
			
            $.fancybox.close();
			alertify.alert("Herramienta modificada exitosamente")
        });
   })
        ...
        function actualizarHerramienta(){
		   ...
		   $.ajax({
                type: 'POST',
                url: 'actualizar_herramienta.php',
   ...
   function editarHerramienta(id) {
                   $.getJSON("obtHerramientaId.php", {id_herramienta: id}, function(data) {
                    $("#CODIGO").val(data[0].CODIGO)
                    $("#NOMBRE").val(data[0].NOMBRE)
                    $("#MARCA").val(data[0].MARCA)
					$("#MODELO").val(data[0].MODELO)
					$("#OBSERVACION").val(data[0].OBSERVACION)
					$("#TIPOHERRAMIENTA").val(data[0].TIPOHERRAMIENTA)
					$("#FRECUENCIA").val(data[0].FRECUENCIA)
					$("#POTENCIA").val(data[0].POTENCIA)
					$("#CANTIDADMINIMA").val(data[0].CANTIDADMINIMA)
					if($('#TIPOHERRAMIENTA').val()=="Electrica"){document.getElementById('POTENCIA').disabled = false;}
                    $("#btnFancybox").click()
   ...
   function tipo(){
	   ...
	   if(seleccionado=="Electrica"){
		     document.getElementById('POTENCIA').disabled = false;document.getElementById('POTENCIA').value="";
		  }
		else{ document.getElementById('POTENCIA').disabled = true;document.getElementById('POTENCIA').value="S/N";}   
	}
