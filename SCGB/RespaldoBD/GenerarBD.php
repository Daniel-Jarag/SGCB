...
<div id="body"> 
    ...
    <div class="container-fluid"> 
      ...
      <div class="row-fluid">
        <div class="span12">
          <h3 class="page-title">Respaldar Base de Datos</h3>
          <ul class="breadcrumb">
            <li> <i class="icon-home"></i> <a href="#">Inicio</a> <span class="icon-angle-right"></span> </li>
            <li> <a href="#">Administracion</a> <span class="icon-angle-right"></span> </li>
            <li><a href="../Ficha_Trabajador/prestamo.php">Respaldar base de datos</a></li>
          </ul>
        </div>
      </div>
      <div class="row-fluid">
                  ...
                  <div class="tab-content">
                    ...
                    <div class="control-group">
                      ...
                      <div class="form-actions">
                             <input type="button" name="enviar" value="Generar" class="btn btn-success" ></input>
