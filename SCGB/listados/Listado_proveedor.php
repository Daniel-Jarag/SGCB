            ...
            <div class="row-fluid hidden-print">
               <div class="span12">
                  ...
                  <ul class="breadcrumb">
                     ...
                     <li><a href="#">Informe Proveedor </a></li>
                  </ul>
...
document.write("<span class='class8' id=fecha>"+dayarray[day]+" "+daym+" de "+montharray[month]+" de "+year+"</span>")
                        ...
                        <table class="table table-advance tabs-stacked">
                           <thead>
                              <tr class="table-condensed">
                                 <th>Rut</th>
                                 <th>Nombre</th>
                                 <th class="hidden-300">Telefono</th>
                                 <th class="hidden-300">Direccion</th>
	...
	$sql = "SELECT RUT,PD_NOMBRE,PD_DIRECCION,PD_TELEFONO,PD_EMAIL FROM proveedor where PD_ESTADO=1";
	conectar();
  ...
  ?>
                              <tr>
                                 <td><?=$row["RUT"];?></td>
                                 <td><?=$row["PD_NOMBRE"];?> </td>
                                 <td class="hidden-480"><?=$row["PD_TELEFONO"];?></td>
								 
                                 <td class="hidden-480"><?=$row["PD_DIRECCION"];?></td>
                                 <td class="hidden-480"><?=$row["PD_EMAIL"];?></td>
