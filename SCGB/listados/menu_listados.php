     ...
     <div class="container-fluid">
            ...
            <div class="row-fluid">
               <div class="span12">
                  ...
                  <h3 class="page-title">Infromes Del Sistema. </h3>
                  <ul class="breadcrumb">
                     <li>
                        <i class="icon-home"></i>
               ...
               <div class="span12">
                  ...
                  <div class="widget box green">
                     <div class="widget-title">
                        <h4><i class="icon-reorder"></i>Informe  </h4>
                     </div>
                     <div class="widget-body form">
                        <!-- Iniio de Botones-->
                           <div class="row-fluid">
                              <a href="../listados/Menu_herramienta.php" class="icon-btn span2">
                                 <i class="icon-cogs"></i>
                                 <div>Herramienta por fecha </div>
                                 <!--<span class="badge badge-important">2</span>-->
                              </a>
                              <a href="../listados/Menu_insumo.php" class="icon-btn span2">
                                 <i class="icon-heart"></i>
                                 <div>Insumo  por fecha</div>
                              </a>
                              <a href="../listados/Menu_ropa.php" class="icon-btn span2">
                                 <i class="icon-group"></i>
                                 <div>Ropa  por fecha</div>
                              </a>
                               <a href="../listados/Listado_herramienta.php" class="icon-btn span2">
                                 <img src="imagenes listado/emblema-de-establecer-los-parametros-de-herramienta-de-trabajo-clave-de-icono-4627-128.png" /><div>
                                 Herramienta</div>
                                 <!--<span class="badge badge-important">2</span>-->
                              </a>
                              <a href="../listados/Listado_insumo.php" class="icon-btn span2">
                                 <img src="imagenes listado/casco-de-seguridad-de-ingenieria-icono-9724-32.png" />
                                 <div>Insumo </div>
                              </a>
                              <a href="../listados/Listado_ropa.php" class="icon-btn span2">
                                 <i class="icon-group"></i>
                                 <div>Ropa</div>
                              </a>
                          </div>
							   <div class="row-fluid">
 <a href="../listados/Listado_cargo_trabajadorb.php" class="icon-btn span2">
                                 <i class="icon-ok-sign"></i>
                                 <div>Listado cargo por trabajador </div>
                              </a>

                              <a href="../listados/Listado_trabajadorb.php" class="icon-btn span2">
                                 <i class="icon-user-md"></i>
                                 <div>Listado trabajador </div>
                              </a>
                              <a href="../listados/Listado_trabajadorscb.php" class="icon-btn span2">
                                 <i class="icon-paste"></i>
                                 <div>Listado trabajador sin contrato</div>
                              </a>
							 
							  <a href="Listado_Obraab.php" class="icon-btn span2">
                                 <i class="icon-paste"></i>
                                 <div>Listado obra abierta </div>
                              </a>
							  <a href="Listado_Obracb.php" class="icon-btn span2">
                                 <i class="icon-paste"></i>
                                 <div>Listado obra cerrada </div>
                              </a>
                             <a href="Listado_obra_productob.php" class="icon-btn span2">
                                 <i class="icon-paste"></i>
                                 <div>Listado producto en obra </div>
                              </a> 
                               </div>
							   <div class="row-fluid">
                                <a href="Listado_obra_producto.php" class="icon-btn span2">
                                 <i class="icon-paste"></i>
                                 <div>Listado producto en obra cerradas</div>
                              </a>
							  <a href="Listado_Producto_proveedorb.php" class="icon-btn span2">
                                 <i class="icon-paste"></i>
                                 <div>Listado producto por proveedores </div>
                              </a> 
							  <a href="Listado_proveedorb.php" class="icon-btn span2">
                                 <i class="icon-paste"></i>
                                 <div>Listado proveedor </div>
                              </a> 
                           </div>
                    </div>
                 </div>
