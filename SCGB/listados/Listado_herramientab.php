...
<!-- BEGIN HEAD --><!-- Mirrored from www.keenthemes.com/preview/conquer/sample_invoice.html by HTTrack Website Copier/3.x [XR&CO'2013], Mon, 14 Oct 2013 16:47:02 GMT -->
            ...
            <div class="row-fluid hidden-print">
               <div class="span12">
                  ...
                  <ul class="breadcrumb">
                     ...
                     <li><a href="#">Informe Herramienta </a></li>
                  </ul>
            ...
            <div id="page">
               <div class="invoice">
                     <div class="row-fluid invoice-logo">
                        <div class="span2 invoice-logo-space"><img src="../assets/img/logo.png"alt="" width="420px" height="200px" /> </div>
                         <div class="span10">
                           <p>
...
document.write("<span class='class8' id=fecha>"+dayarray[day]+" "+daym+" de "+montharray[month]+" de "+year+"</span>")
                           ...
                           <thead>
                              <tr class="table-condensed">
								<th>Codigo</th>
                                 ...
                                 <th class="hidden-300">Tipo Herramienta</th>
                                 <th class="hidden-300">Cantida</th>
  ...
  ?>
                              <tr>
                                 ...
                                 <td class="hidden-480"><?=$row["H_TIPOHERRAMIENTA"];?></td>
