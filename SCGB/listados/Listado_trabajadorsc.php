         ...
         <div class="container-fluid">
            ...
            <div class="row-fluid hidden-print">
               <div class="span12">
                  ...
                  <h3 class="page-title">
                  Informe trabajadores sin contrato </h3>
                  <ul class="breadcrumb">
                     <li>
                        <i class="icon-home"></i>
...
document.write("<span class='class8' id=fecha>"+dayarray[day]+" "+daym+" de "+montharray[month]+" de "+year+"</span>")
                          ...
                          <h1>Listado trabajadores sin contrato vigente </h1> 
                          </span></p>
                        </div>
                     </div>
	...
	$sql4 = "SELECT t.RUN , CONCAT( t.T_NOMBRE,' ' , t.T_APELLIDO ) AS nombre,  t.T_SEXO,T_DIRECCION,t.T_TELEFONO
FROM trabajador t , cargo c
where t.CODIGOCARGO=c.CODIGOCARGO and T_ESTADO=2";
	conectar();
	$rs4=mysql_query($sql4,$conexion);	
  ...
  ?>
                              <tr>
                                 <td><?=$row4["RUN"];?></td>
                                 <td><?=$row4["nombre"];?> </td>
                                 <td ><?=$row4["T_TELEFONO"];?></td>
								 
                                 <td ><?=$row4["T_DIRECCION"];?></td>
                                 <td ><?=$row4["T_SEXO"];?> echo "soy yo"</td>
