         ...
         <div class="container-fluid">
            ...
            <div class="row-fluid">
               <div class="span12">
                  ...
                  <h3 class="page-title">Informe de obra</h3>
                  <ul class="breadcrumb">
                     <li>
                        <i class="icon-home"></i>
               ...
               <div class="span12">
                  ...
                  <div class="widget box green">
                     <div class="widget-title">
                        <h4><i class="icon-reorder"></i>Informe Obra  </h4>
                     </div>
                     <div class="widget-body form">
                        <!-- Iniio de Botones-->
                           <div class="row-fluid">
                             <a href="../listados/Listado_Obraa.php" class="icon-btn span3">
                                 <i class="icon-cogs"></i>
                                 <div>Obra Activas  </div>
                                <!--<span class="badge badge-important">2</span>-->
                             </a>
                              <a href="Listado_Obrac.php" class="icon-btn span3">
                                 <i class="icon-heart"></i>
                                 <div>Obra Cerrada </div>
                              </a>
                              <a href="Listado_obra_producto.php" class="icon-btn span3">
                                 <i class="icon-group"></i>
