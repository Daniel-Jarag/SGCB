            ...
            <div class="row-fluid hidden-print">
               <div class="span12">
                  ...
                  <ul class="breadcrumb">
                     ...
                     <li>
                         <a href="../Producto/Productosb.php">Informe</a>
                        <i class="icon-angle-right"></i>
                     </li>
...
document.write("<span class='class8' id=fecha>"+dayarray[day]+" "+daym+" de "+montharray[month]+" de "+year+"</span>")
	...
	$sql = "SELECT p.CODIGOPRODUCTO,p.P_NOMBRE,p.P_MARCA,p.P_MODELO,p.P_OBSERVACION,i.I_CANTIDAD,s.S_CANTIDAD FROM insumo i,producto p,stock s
