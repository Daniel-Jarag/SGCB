         ...
         <div class="container-fluid">
            ...
            <div class="row-fluid hidden-print">
               <div class="span12">
                  ...
                  <h3 class="page-title">
                  Informe Productos por Obras </h3>
                  <ul class="breadcrumb">
                     <li>
                        <i class="icon-home"></i>
                     ...
                     <li>
                        <a href="menu_listados.php">Informe</a>
...
document.write("<span class='class8' id=fecha>"+dayarray[day]+" "+daym+" de "+montharray[month]+" de "+year+"</span>")
                          ...
                          <h1>Producto por Obra cerrada </h1> 
                          </span></p>
                        </div>
                     </div>
	...
	$sql = "SELECT CODIGOOBRA, O_NOMBRE,O_FECHAINICIO,O_FECHATERMINO FROM obra WHERE O_ESTADO=2";
	conectar();
		$rss=mysql_query($sql,$conexion);	
