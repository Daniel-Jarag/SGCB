  ...
  ?>
		...
		?>
           <li class="has-sub active ">
               ...
               <ul class="sub">
                 <li ><a href="../Herramienta/add_herramienta.php">Herramienta</a></li>
               ...
               <div class="span12">
                  ...
                  <div class="widget box green">
                     <div class="widget-title">
                        <h4><i class="icon-reorder"></i>Agredar Productos</h4>
                     </div>
                     <div class="widget-body form">
                        <!-- Iniio de Botones-->
                           <div class="row-fluid">
                              <a href="../Herramienta/mod_herramienta.php" class="icon-btn span3">
                                 <i class="icon-cogs"></i>
                                 <div>Herramienta </div>
                                 <!--<span class="badge badge-important">2</span>-->
                              </a>
                              <a href="../Insumo/mod_insumo.php" class="icon-btn span3">
                                 <i class="icon-pencil"></i>
                                 <div>Insumo</div>
                              </a>
                              <a href="../Ropa/mod_ropa.php" class="icon-btn span3">
                                 <i class="icon-group"></i>
                                 <div>Ropa</div>
                              </a>
                           </div>
                           <div class="row-fluid">
                              <a href="../Vehiculo/mod_vehiculo.php" class="icon-btn span3">
