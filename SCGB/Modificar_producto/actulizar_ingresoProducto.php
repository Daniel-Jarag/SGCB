...
$cn2->Conectar();
$return_arr2 = array();
$res2 = $cn2->Consulta("UPDATE ingreso_producto 
 SET RUT='$RUT',IP_CANTIDAD='$CANTIDAD',IP_PRECIOUNITARIO='$PRECIO',IP_TOTALFACTURA='$TOTALFACTURA',IP_FECHA='$FECHA',IP_USUARIO='$USUARIO' WHERE NUMEROFACTURA='$NUMEROFACTURA' AND CODIGOPRODUCTO='$CODIGO'");
$cn->Desconectar();
$cn2->Desconectar();
?>