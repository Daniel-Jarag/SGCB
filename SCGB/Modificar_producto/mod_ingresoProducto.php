...
<div id="body">
     ...
     <div class="container-fluid">
            <div class="row-fluid">
               <div class="span12">
                  <h3 class="page-title">Modificar Ingreso de Producto</h3>
                  <ul class="breadcrumb">
                     <li>
                        <i class="icon-home"></i>
                        <a href="#">Incio</a> 
                     ...
                     <li><a href="add_cargo.php">Modificar Ingreso Producto</a></li>
                  </ul>
               ...
               <div class="span12">
                  <div class="widget box green">
                     <div class="widget-title">
                        <div class="widget-title">
                        <h4><i class="icon-globe"></i>Tabla Modificar Ingreso Producto</h4>
                        </div>
                     </div>
                     <div class="widget-body form">
                     <div class="clearfix margin-bottom-10">
                       </div>
                        <h3>Lista de Ingreso de Producto</h3>
...
<div id="footer">
 ...
 <script>
   ...
   $("#tab1").load("tbModIngresoProducto.php");
     })
	 
   function eliminarStock(id) {
	   
	   alertify.confirm("Desea Eliminar este Ingreso de Producto?", function (e) {
	   if (e==false) {
			return;  
        }
		else {
	   $.getJSON("../Stock/obtStockId.php", {id_factura: id}, function(data) {
	   NUMEROFACTURA=data[0].NUMEROFACTURA;
	   for(i=0;i<data.length;i++){
		   CODIGO=data[i].CODIGOPRODUCTO;
		   DIFERENCIA=data[i].CANTIDAD;
			$.ajax({
            type: 'POST',
		 ...
		 eliminarIngreso(NUMEROFACTURA);
		 eliminarFactura(NUMEROFACTURA);
		 window.location.href='mod_ingresoProducto.php';
         })
   ...
   function eliminarIngreso(NUMEROFACTURA) {
		 $.ajax({
         type: 'POST',
         url: 'eliminar_productoUnitario.php',
