            ...
            <div class="row-fluid">
               <div class="span12">
                  ...
                  <ul class="breadcrumb">
                     ...
                     <li>
                        <a href="mod_ropa.php">Ropa</a>
                        <i class="icon-angle-right"></i>
                     </li>
                     <li><a href="add_ropa.php">Agregar Ropa</a></li>
                  </ul>
               ...
               <div class="span12">
                  <div class="widget box green">
                     <div class="widget-title">
                        <h4><i class="icon-reorder"></i>Agredar Ropa</h4>
                     </div>
                        ...
                        <form action="" method="post" id="form2" name="form2"  class="form-horizontal">  
                          <div class="alert alert-error hide">
                           ...
                           <div class="control-group">
                              ...
                              <div class="controls">
							  <?php $sql="Select count(CODIGOPRODUCTO)+1 AS ID from ropa";
	conectar();
	$rs=mysql_query($sql,$conexion);	
							  while ($row=mysql_fetch_array($rs)){?>
                             <input type="text"  name="CODIGO" id="CODIGO" class="span6  m-wrap tooltips" data-trigger="hover" data-original-title="Ingrese un codigo de insumo."  value="ROP-<?=$row["ID"]; }?> " disabled="disabled"/>
                             </div>
                           </div>
                           ...
                           <div class="control-group">
                              ...
                              <div class="controls">
                                <input type="text"  name="NOMBRE" id="NOMBRE" class="span6  m-wrap tooltips" placeholder="Ingrese nombre de ropa." required />
                             </div>
                           </div>
                           ...
                           <div class="control-group">
                              ...
                              <div class="controls">
                                 <input type="text"  name="MARCA" id="MARCA" class="span6  m-wrap tooltips" placeholder="Ingrese marca de ropa."  required/>
                              </div>
                           </div>
                           ...
                           <div class="control-group">
                              ...
                              <div class="controls">
                                 <input type="text"  name="MODELO" id="MODELO" class="span6  m-wrap tooltips" placeholder="Ingrese modelo de ropa." required />
                              </div>
                           </div>
                           ...
                           <div class="control-group">
                              ...
                              <div class="controls">
                                 <input type="text"  name="TALLA" id="TALLA" class="span6  m-wrap tooltips" placeholder="Ingrese una talla de ropa." required />
                              </div>
                           </div>
                             ...
                             <div class="control-group">
                              ...
                              <div class="controls">
                                 <input type="text"  name="COLOR" id="COLOR" class="span6  m-wrap tooltips"placeholder="Ingrese color de ropa." required />
                              </div>
                           </div> 
                           ...
                           <div class="control-group">
                              ...
                              <div class="controls">
                                 <input type="text"  name="MATERIAL" id="MATERIAL" class="span6  m-wrap tooltips" placeholder="Ingrese material de ropa." required />
                              </div>
                           </div>                        
                          ...
                          <div class="control-group">
                           ...
                           <div class="controls">
                              <textarea name="OBSERVACION" id="OBSERVACION" maxlength="200" class="span6  m-wrap tooltips" ></textarea>
                          </div>
                        </div>
	   ...
	   $("#form2").submit(function(e){ 
		   ...
		   IDENTIFICADOR= "R"   
            ...
            $.ajax({
			   ...
			   form2.TALLA.value = "";
			   form2.COLOR.value = "";
			   form2.MATERIAL.value = "";
			   form2.OBSERVACION.value = "";
			   form2.CANTIDADMINIMA.value = "0";
     alertify.alert("Ropa agregado exitosamente");
                }
            });
	  ...
	  function guardaInsumo(){
		  ...
		  function volver(){
		  window.location.href='mod_ropa.php';
		  }
   </script>  
</body>
</html>