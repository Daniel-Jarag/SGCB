               ...
               <div class="span12">
                  <div class="widget box green">
                     ...
                     <div class="clearfix margin-bottom-10">
                           <div class="btn-group">
                              <button id="sample_editable_1_new" class="btn btn-success" onclick = "location.href = 'enviar_mantencion.php'">
                              Enviar a Mantención <i class="icon-plus"></i>
                              </button>
                           </div>
                       </div>
                        <h3>Listado de Productos en Mantención</h3>
                         <div id="tab1" class="table table-striped table-bordered table-hover"></div>                         <input type="hidden" name="CODIGOPRODUCTO"  id="CODIGOPRODUCTO" />
                         <input type="hidden" name="CODIGOUNITARIO"  id="CODIGOUNITARIO" />
                 ...
                 <div style="display: none;" id='editarFormulario'>
                          ...
                          <h3>Datos de Retiro de Mantención</h3>
                        <form action="" method="post" id="form2" name="form2"  class="form-horizontal">
                        
                          <div class="control-group">
                           <label class="control-label">Fecha Devolución <span class="required"></span></label>
                              <div class="controls">
                            <input  type="text" class="span6 " name="FECHADEVOLUCION" id="FECHADEVOLUCION" />
                              </div>
                           </div>
                        ...
                        <div class="control-group">
                              ...
                              <div class="controls">
                                <textarea name="COMENTARIO" class="span6  m-wrap tooltips" id="COMENTARIO" ></textarea>
                              </div>
                           </div>
...
<script src="../assets/scripts/table-managed.js"></script> 
 ...
 <script>
   ...
   $("#tab1").load("tbMantencion.php");
   $("#btnFancybox").fancybox();
   App.init();
   
   		$("#form2").submit(function(e){ 
           CODIGOPRODUCTO= $('#CODIGOPRODUCTO').val()
		   CODIGOUNITARIO= $('#CODIGOUNITARIO').val()
		   ...
		   USUARIO= $('#USUARIO').val()
            ...
            $.ajax({
                ...
                data: { CODIGOPRODUCTO:CODIGOPRODUCTO, CODIGOUNITARIO: CODIGOUNITARIO, FECHA: FECHA, COMENTARIO:COMENTARIO, USUARIO:USUARIO},
			...
			actualizarProducto();
			actualizarStock();
			window.location.href='mantencion.php';
            $.fancybox.close();
        });
   })
   ...
   function actualizarProducto(){
		   ...
		   $.ajax({
                ...
                data: { CODIGOPRODUCTO:CODIGOPRODUCTO, CODIGOUNITARIO:CODIGOUNITARIO}
		         });
		  }
   ...
   function eliminarMantencion(id) {
			   var elem = id.split('**&**');
			   $("#CODIGOPRODUCTO").val(elem[0]);
			   $("#CODIGOUNITARIO").val(elem[1]);
			   $("#FECHADEVOLUCION").val("");
			   $("#COMENTARIO").val("");
               $("#btnFancybox").click()
             }
