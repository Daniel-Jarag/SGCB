            ...
            <div class="row-fluid">
               <div class="span12">
                  ...
                  <ul class="breadcrumb">
                     ...
                     <li><a href="mod_trabajador.php">Buscar Trabajador</a></li>
                  </ul>
               ...
               <div class="span12">
                  <div class="widget box green">
                     <div class="widget-title">
                        <div class="widget-title">
                        <h4><i class="icon-globe"></i>Tabla de Trabajador</h4>
                     </div>
                     </div>
                     <div class="widget-body form">
                     <div class="clearfix margin-bottom-10">
                           <div class="btn-group">
                              <button id="sample_editable_1_new" class="btn btn-success" onclick = "location.href = 'add_trabajador.php'">
                              Agregar Trabajador <i class="icon-plus"></i>
                              </button>
                           </div>
                 ...
                 <div style="display: none;" id='editarFormulario'>
                        ...
                        <form action="" method="post" id="form2" name="form2"  class="form-horizontal">
                           ...
                           <div class="control-group">
                              ...
                              <div class="controls">
                                 <input  name="RUT" type="text" class="span6  m-wrap tooltips" id="RUT" readonly data-trigger="hover" required />
                              </div>
                           </div>
                           ...
                           <div class="control-group">
                              ...
                              <div class="controls">
		                            <select   name="CARGO" id="CARGO" class="span6" data-trigger="hover" required >
		                              <?php while($row = $cn->getRespuesta($res)){ ?>
		                              <option value="<?php echo $row['CODIGOCARGO']; ?>" ><?php echo $row['C_NOMBRE']; ?></option>
		                              <?php
                                       }
                                      ?> 
	                                </select> 
                           ...
                           <div class="control-group">
                              ...
                              <div class="controls"> <select class="span6 " name="SEXO"id ="SEXO" >
                          ...
                          <div class="control-group">
                              ...
                              <div class="controls">
                                 <input type="text" name="DIRECCION" id="DIRECCION" class="span6" required/>
                              </div>
                           </div>
                        ...
                        <div class="control-group">
                              ...
                              <div class="controls">
                                  <input type="text" name="TELEFONO" id="TELEFONO"  class="span6" data-trigger="hover"  required/>
                              </div>
                           </div>
                            <div class="control-group">
                              <label class="control-label">Fecha Inicio Contrato</label>
                              <div class="controls">
                                  <input type="datetime" name="FECHA" id="FECHA"  class="span6" data-trigger="hover" required  />
                              </div>
                           </div>
                           <div class="control-group">
...
<script type="text/javascript" src="../js_mantenedores/jquery.msgbox.min.js"></script>
 ...
 <script>
   ...
   App.init();
		   ...
		   TELEFONO= $('#TELEFONO').val()        
			...
			editarHistorico();
            $.fancybox.close();
			$.msgbox("Trabajador Modificado Exitosamente",{type: "info",buttons : [{type: "submit", value: "Aceptar"}]},function(result) { if(result=="Aceptar"){window.location.href='mod_trabajador.php';} });
        });
   })
   ...
   function editarTrabajador(id,codigoHistorico) {
                   $.getJSON("obtTrabajadorId.php", {id_trabajador: id,codigoHistorico:codigoHistorico}, function(data) {
                    $("#RUT").val(data[0].RUT)
					...
					$("#CODIGOHISTORICO").val(codigoHistorico)
                    $("#btnFancybox").click()
	...
	function eliminarTrabajador(id,nombre) {
         ...
         $.msgbox("¿Desea Eliminar el Trabajador(a) "+nombre+"?", {type: "confirm",buttons : [{type: "submit", value: "SI"},{type: "submit", value: "NO"}]}, function(result) { 
		 if(result=="SI"){
			 $.getJSON("obtTrabajador.php", {id_trabajador: id}, function(data) {
                   $("#CODIGO").val(data[0].RUT)
				    CODIGO= $('#CODIGO').val()
				   $.ajax({
                     type: 'POST',
                     url: 'eliminar_trabajador.php',
                     data: { CODIGO: CODIGO},
                     success: function(data){
					  $.msgbox("Trabajador Eliminado Exitosamente",{type: "info",buttons : [{type: "submit", value: "Aceptar"}]},function(result) { if(result=="Aceptar"){window.location.href='mod_trabajador.php';} });
                     }
                  });
               })
			 } 
 ...
 function cargo_recupera(cargo){
				  for(i=0;i<document.form2.CARGO.length;i++){
					   if(document.form2.CARGO.options[i].text==cargo){
						   x=document.form2.CARGO.options[i].value;
						   document.form2.CARGO.value=x;
						   }
					  }
				  }
