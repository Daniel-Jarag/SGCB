...
<table id='tablaTrabajador' class="table table-striped table-bordered table-hover" >
    ...
    <tbody>
        ...
        <tr>
            ...
            <td align="center">
                <a href="javascript:editarTrabajador('<?php echo $row['RUN']; ?>','<?php echo $row['CODIGO']; ?>')"><img src="../Imagenes/Edit_Male_User_Icon_32.png" style="vertica-align: middle;" /> </a>
            </td>
            <td align="center">
                <a href="javascript:eliminarTrabajador('<?php echo $row['RUN']; ?>','<?php echo $row['T_NOMBRE']." ".$row['T_APELLIDO']; ?>')"><img src="../Imagenes/Remove_Male_User_Icon_32.png" style="vertica-align: middle;" /> </a>
            </td>
