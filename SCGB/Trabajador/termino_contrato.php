...
<div id="body">
     <div class="container-fluid">
            <div class="row-fluid">
               <div class="span12">
                  <h3 class="page-title">Termino de Contrato</h3>
                  <ul class="breadcrumb">
                     <li>
                        <i class="icon-home"></i>
                     ...
                     <li><a href="termino_contrato.php">Termino de Contrato</a></li>
                  </ul>
               ...
               <div class="span12">
                  <div class="widget box green">
                     <div class="widget-title">
                        <div class="widget-title">
                        <h4><i class="icon-globe"></i>Tabla de Termino de Contrato</h4>
                     </div>
                     </div>
                 ...
                 <div style="display: none;" id='editarFormulario'>
                        ...
                        <form action="" method="post" id="form2" name="form2"  class="form-horizontal">
                           <input  type="hidden" class="span6 " name="RUN" id="RUN" />
                           <input  type="hidden" class="span6 " name="CODIGOHISTORICO" id="CODIGOHISTORICO" />
                          <div class="control-group">
                           <label class="control-label">Fecha de Termino</label>
                              <div class="controls">
                            <input  type="date" class="span6 " name="FECHA" id="FECHA" required />
                              </div>
                           </div>
                        ...
                        <div class="control-group">
                              ...
                              <div class="controls">
                                <textarea name="OBSERVACION" class="span6" id="OBSERVACION"></textarea>
                              </div>
                           </div>
...
<script type="text/javascript" src="../js_mantenedores/jquery.msgbox.min.js"></script>
 ...
 <script>
   ...
   $("#tab1").load("tbTerminoContrato.php");
   ...
   App.init();
		   ...
		   CODIGOHISTORICO=$('#CODIGOHISTORICO').val()       
            ...
            $.ajax({
                type: 'POST',
                url: 'guardar_terminoContrato.php',
                data: { RUN:RUN, FECHA:FECHA, OBSERVACION:OBSERVACION,CODIGOHISTORICO:CODIGOHISTORICO},
                success: function(data){
                $.fancybox(data)
                }
            });
            $.fancybox.close();
			$.msgbox("El termino de Contrato ha sido Guardado Exitosamente",{type: "info",buttons : [{type: "submit", value: "Aceptar"}]},function(result) { if(result=="Aceptar"){window.location.href='termino_contrato.php';} });
        });
   })
	 
	function terminarContrato(id) {
		  $.getJSON("obtContratoId.php", {id_trabajador: id}, function(data) {
                    $("#RUN").val(data[0].RUN)
